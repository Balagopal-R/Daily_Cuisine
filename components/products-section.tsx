  ...
  return (
    <section id="products" ref={sectionRef} className="bg-secondary py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        {/* Product Carousel - Horizontally Scrollable */}
        <div className="overflow-x-auto pb-4">
          <div className="flex gap-6 min-w-max">
            {currentCategory.products.map((product) => (
              <div
                key={product.name}
                className="group w-64 flex-shrink-0 overflow-hidden rounded-xl border border-border bg-background transition-shadow hover:shadow-lg"
              >
